...
async function Registro_de_Usuario_Email_Existe() {
    ...
    const Photo = async() => {
        await driver.takeScreenshot().then(
            function(image, err) {
                Counter = Counter + 1
                require('fs').writeFileSync(`../ScreenShots/Registro_de_Usuario_Email_Existe.png`, image, 'base64');
            }
        );
    }
...
Registro_de_Usuario_Email_Existe();